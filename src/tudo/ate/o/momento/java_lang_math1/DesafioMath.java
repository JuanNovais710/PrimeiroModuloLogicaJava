...
public class DesafioMath {
    public static void main(String[] args) {
        ...
        System.out.println("Quantos jogos deverão ser feitos? Lembrando que cada jogo possui 6 números: ");
        double quantidadeDeJogos = scanner.nextDouble();
        double resultado = Math.random() * 60;
    }
}
