...
public class Megasena {
    private static final int NUMERO_JOGOS = 6;
    private static final int MAXIMO_NUMEROS = 60;
    private int[] numerosSorteados;

    public void sortear() {
        numerosSorteados = new int[NUMERO_JOGOS];
        for(int i = 1; i <= NUMERO_JOGOS; i++) {
            int numeroSorteado = (int) Math.round(Math.random() * MAXIMO_NUMEROS);
